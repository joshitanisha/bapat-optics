...
const CartController = require("../../../../controllers/api/v1/website/cart/cart.controller");
...
router.delete("/lens-delete/:id", AuthMiddlewareCustomer, CartController.Lensedelete);
