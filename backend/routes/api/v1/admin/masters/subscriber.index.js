...
const SubscriberController = require("../../../../../controllers/api/v1/admin/masters/subscriber.controller.js");
router.get(
    "/",
    // Validation.email,
    SubscriberController.findAll
);
// router.get(
//     "/:id",
...
//     Validation.time,
//     Validation.appointment_reason_id,
//     Validate,
