...
const CouponController = require("../../../../controllers/api/v1/mobile/coupons/coupons.controller");
...
router.post("/valid", Validation.amount,
  Validation.code,
  Validate, CouponController.validCouponCode);
