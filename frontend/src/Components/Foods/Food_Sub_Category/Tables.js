...
const Tables = () => {
  ...
  const Sample = async (e) => {
    try {
      await getDownloadDataExcel("/admin/masters/p-category/sample", {}, "state");
    } catch (error) {
      console.error("Error uploading file:", error);
    }
  };
  ...
  return (
    <>
      <div className="main-advancedashboard">
        <Header title={"Sub Category"} link={"/admin/masters/p-category"} />
                    ...
                    <div className="row">
                      <div className="col-xxl-2 col-xl-2 col-lg-4 col-md-6 col-sm-6 col-12">
                        <div className="add me-3">
                          {isAllow.includes(IDS.StoreSubCategory.Add) ? (
                            <Link
                              // to="/admin/masters/p-category/add"
                              type="button"
                            ...
                            <div className="col-xxl-3 col-xl-4 col-lg-4 col-md-6  col-sm-6 col-12 mb-2">
                              <div className="num">
                                ...
                                <input
                                  ...
                                  id=""
                                  value={search}
                                  placeholder="Search Food Sub Category"
                                  onChange={(e) => {
                                    setonPageChange(1);
                                  ...
                                  {visible.col5 && (
                                    <td>
                                      <div className="d-flex">
                                        {isAllow.includes(
                                          IDS.StoreSubCategory.Edit
                                        ) ? (
                                          <Button
                                            // to={`/admin/masters/p-category/edit/${d?.id}`}
