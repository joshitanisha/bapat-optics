...
function Edit() {
  ...
  const {
    ...
    defaultValues: {
      variants: [{ size: "", color: "", price: "" }], // Default empty field
    },
  });
  ...
  const handleImageChange1 = (e) => {
    ...
    if (file) {
      const reader = new FileReader();
      reader.onloadend = () => {
        setImagePreview1(reader.result); // Set image preview
      };
      reader.readAsDataURL(file);
    }
  };
            ...
            <div className="package-details-section">
              ...
              {/* <Row className="detail-row">
                ...
                <Col lg={4} md={4}>
                  ...
                  {errors.manufacturer && (
                    <span className="text-danger">{errors.manufacturer.message}</span>
                  )}
                </Col>
              </Row> */}
              <Row className="detail-row">
                        ...
                        <Row className="justify-content-center">
                          ...
                          <Form.Group>
                            <Form.Control
                              ...
                              className={classNames("", {
                                "is-invalid": errors?.variants?.[index]?.description,
                              })}
