...
const AddOffCanvance = (props) => {
  ...
  const GetAllCategory = async () => {
    ...
    if (response?.success) {
      setCountries(await Select2Data(response?.data, "add_on_category_id"));
    }
  };
  ...
  const onSubmit = async (data) => {
    try {
      ...
      DataToSend.append("add_on_category_id", data?.add_on_category_id?.value);
              ...
              <Col md={6}>
                <div className="main-form-section mt-3">
                  <Row className="justify-content-center">
                    <Form.Label>Food Add On </Form.Label>
                    <Form.Group>
                      <InputGroup>
                        <Form.Control
                          type="text"
                          name="name"
                          placeholder="Food Add On "
                          className={classNames("", {
                            "is-invalid": errors?.name,
                          })}
                          {...register("name", {
                            required: "Food Add On is required",
                          })}
                        />
                      </InputGroup>
                      {errors.name && (
                  ...
                  <Form.Group>
                    ...
                    <InputGroup>
                      <Form.Control
                        ...
                        {...register("image", {
                          // required: !getValues("gallery_image") ? "Image is required" : false,
                        })}
                        accept="image/*"
