...
const Tables = () => {
  ...
  const getDataAll = async () => {
    const response = await getData(
      `/admin/masters/p-category?page=${onPageChange}&per_page=${perPage}&term=${encodeURIComponent(search)}&item_type_id=${ItemType.Food}`
  ...
  const ChangePupularStatus = async (id) => {
    const response = await editStatusData(`/admin/masters/p-category/popular/${id}`);
    setChangeStatus(response);
  };
  ...
  const BulkUpload = async (e) => {
    try {
      ...
      const response = await postData("/admin/masters/p-category/bulk", formData, {});
      if (response?.success) {
  ...
  const Sample = async (e) => {
    try {
      await getDownloadDataExcel("/admin/masters/p-category/sample", {}, "Category");
    } catch (error) {
      console.error("Error uploading file:", error);
    }
  };
  ...
  return (
    <>
      <div className="main-advancedashboard">
        <Header title={"Food Category"} link={"/masters/category"} />
                    ...
                    <div className="row">
                      <div className="d-flex">
                        <div className="add me-3">
                          {isAllow.includes(IDS.FoodCategory.Add) ? (
                            <Link
                              // to="/admin/masters/s-category/add"
                              type="button"
                        ...
                        <Table striped bordered hover responsive center>
                          <thead>
                            <tr className="">
                              ...
                              {/* {visible.col5 && (
                                <th className="tax-name">Popular Status</th>
                              )} */}
                              {visible.col3 && (
                              ...
                              return (
                                <tr className="" key={index}>
                                  ...
                                  {visible.col4 && (
                                    <td>
                                      <div className="d-flex">
                                        {isAllow.includes(IDS.FoodCategory.Edit) ? (
                                          <EditButton
